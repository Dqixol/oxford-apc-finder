...
PNAS welcomes submissions in all scientific disciplines from researchers worldwide. Information on submitting your manuscript is included below. Due to the volume of submissions received, PNAS does not consider presubmission inquiries. Please contact us if you have any questions about the submission process. [Click here](https://web.archive.org/web/20260617040225/https://academic.oup.com/pnasnexus/pages/general-instructions) for information about submitting to _PNAS Nexus_.

[Submit Your Manuscript](https://web.archive.org/web/20260617040225/https://www.pnascentral.org/cgi-bin/main.plex) [Contact Us](about:/web/20260617040225/https://www.pnas.org/cdn-cgi/l/email-protection#41312f2032012f20326f2425347e3234232b2422357c1034243235282e2f61332426203325282f2661110f0012611234232c283232282e2f61621a042f35243361080561092433241c)
...
*   **Contributed submissions:** NAS members may contribute two research manuscripts annually within their area of expertise in which they had a direct, significant role in the design and execution of the work. Learn more about the [Contributed submissions](/web/20260617040225/https://www.pnas.org/author-center/member-contributed-submissions) process.
...
*   All Brief Reports follow the [Direct Submission](/web/20260617040225/https://www.pnas.org/author-center/editorial-and-journal-policies) mode of review and are not eligible as member-contributed submissions.
...
**[Inaugural Articles](/web/20260617040225/https://www.pnas.org/topic/badge/inaugural)** provide newly elected NAS members an opportunity to introduce themselves to the readers of PNAS. Inaugural Articles may be submitted by newly elected NAS members within five years of election. These are predominantly original research articles that may contain new ideas or hypotheses or describe the historical development of the member’s field. They may contain a personal perspective component, but Review articles are not considered.

**[Front Matter](/web/20260617040225/https://www.pnas.org/front-matter)** is a magazine section that tells the stories of science. Sections include News Features, Science and Culture, Inner Workings, Core Concepts, QnAs, Profiles, and the _Science Sessions_ podcast. All of these elements are written or produced by science writers and journalists who receive assignments from PNAS editors.

**[Perspectives](/web/20260617040225/https://www.pnas.org/topic/pers)** should identify a critical science problem, provide a state-of-the-art assessment, and offer new insights or a new approach to its resolution. The narrative style may vary, but each Perspective should focus on an important area of research and be accessible to a broad scientific audience. Perspectives may help contextualize findings within a field or add a new dimension to previously published research. Current advances and novel insights are encouraged. To submit a proposed article, select “Presubmission for Perspective.” Invited Perspectives are reviewed as described in the [Peer Review Process](about:/web/20260617040225/https://www.pnas.org/author-center/editorial-and-journal-policies#peer-review-process). PNAS allows up to a maximum of 10 pages for these articles.
...
3.  data sharing plans (for all data, documentation, and code used in analysis)
4.  funding information and whether an open access license has been selected
5.  list of appropriate [Editorial Board members](/web/20260617040225/https://www.pnas.org/about/editorial-board), [NAS members](https://web.archive.org/web/20260617040225/https://nrc88.nas.edu/pnas_search/default.aspx), and qualified reviewers (minimum of three each) who are experts in the paper's scientific area. (A brief justification for suggested reviewers is welcome, particularly for interdisciplinary papers)
...
[To learn more about the initial submission process for member-contributed submissions, click here.](/web/20260617040225/https://www.pnas.org/author-center/member-contributed-submissions) Please note that the final version of the paper must be submitted by the last day of the year to count toward that year's annual limit.

Revised Submissions
-------------------

**Revised papers must be submitted within two months of receiving the revision decision or they will be treated as new submissions.** If you need more time, please notify [PNAS](/web/20260617040225/https://www.pnas.org/about/staff-directory). Along with the information provided at initial submission, revised submissions must also include:

*   a revised version of the manuscript, and
*   a point-by-point response to reviewer comments

The revised version of the manuscript should be uploaded as a Manuscript file type. Authors are strongly encouraged to include a tracked-changes file for review purposes. Revised submissions are encouraged to adhere to all **Manuscript Formatting Guidelines**, including the **Publication-Ready Source File Guidelines**. Please note that multiple revisions are rarely permitted, and acceptance of the paper is not guaranteed. If you have any questions regarding manuscript formatting or the revision process, please [contact us](about:/web/20260617040225/https://www.pnas.org/cdn-cgi/l/email-protection#72021c1301321c13015c171607) for assistance.

Manuscript Formatting Guidelines
--------------------------------

Read the [Initial Submission Guidelines](about:/web/20260617040225/https://www.pnas.org/author-center/submitting-your-manuscript#initial-submissions) to learn about formatting requirements for submitting to PNAS. Before preparing your revised submission, be sure to review the [Revised Submission Guidelines](about:/web/20260617040225/https://www.pnas.org/author-center/submitting-your-manuscript#revised-submissions). Detailed formatting instructions are provided below.
...
[Research article](/web/20260617040225/https://www.pnas.org/pb-assets/authors/PNASTemplateforMainManuscript-1755285180130.docx)

[Research article](https://web.archive.org/web/20260617040225/https://www.overleaf.com/latex/templates/template-for-preparing-your-research-report-submission-to-pnas-using-overleaf/fzcbzjvpvnxn)

[Brief Report](/web/20260617040225/https://www.pnas.org/pb-assets/authors/PNASTemplateBR-1755285179960.docx)

[Brief Report](https://web.archive.org/web/20260617040225/https://www.overleaf.com/latex/templates/template-for-preparing-your-research-report-submission-to-pnas-using-overleaf-2025/whbdryzwztnd)

[SI Appendix](/web/20260617040225/https://www.pnas.org/pb-assets/authors/PNAStemplateSI-1755285180080.docx)

[SI Appendix](https://web.archive.org/web/20260617040225/https://www.overleaf.com/latex/templates/pnas-template-for-supplementary-information/wqfsfqwyjtsd#.WrAIzcPwZEZ)

Support for LaTeX templates is available through [Overleaf](https://web.archive.org/web/20260617040225/https://www.overleaf.com/contact). If you have questions about submitting your manuscript in LaTeX, please [contact PNAS](about:/web/20260617040225/https://www.pnas.org/cdn-cgi/l/email-protection#3a4a545b497a545b49145f5e4f) and include the manuscript file as an attachment when possible.
...
5.  Acknowledgments and funding sources
    ...
    *   Use [FundRef](https://web.archive.org/web/20260617040225/https://www.crossref.org/services/funder-registry/) to identify the standard name for any funders
...
PNAS requires the corresponding author to supply an ORCID identifier at submission and strongly encourages all authors to use an ORCID ID. Do not include ORCIDs in the manuscript file; individual authors must link their ORCID account to their PNAS profile at [www.pnascentral.org](https://web.archive.org/web/20260617040225/https://www.pnascentral.org/). For proper authentication, authors are not permitted to add ORCIDs on proofs. [Learn more or register for ORCID](https://web.archive.org/web/20260617040225/https://orcid.org/).
...
*   Use standardized nomenclature for species-specific gene and protein names (see [Genecards](https://web.archive.org/web/20260617040225/https://www.genecards.org/), [MGI Nomenclature page](https://web.archive.org/web/20260617040225/http://www.informatics.jax.org/mgihome/nomen/index.shtml), [HUGO Gene Nomenclature Committee](https://web.archive.org/web/20260617040225/https://www.genenames.org/), [the Wheat Initiative](https://web.archive.org/web/20260617040225/https://link.springer.com/article/10.1007/s00122-023-04253-w), or equivalent resources).
    *   Proposed gene names must be deposited to and approved by the appropriate nomenclature committee before publication of the article.
...
*   Use international standards on nomenclature. PNAS uses _Scientific Style and Format: The CSE Manual for Authors, Editors, and Publishers_ (8th edition, 2014) as the primary style guide.
*   If you believe your manuscript would benefit from professional editing, we encourage you to use an editing service (see list [here](/web/20260617040225/https://www.pnas.org/author-center/language-editing)) prior to submission. PNAS does not take responsibility for or endorse these services, and their use has no bearing on acceptance of a manuscript for publication.
*   We encourage authors to follow the [Text Recycling Research Project’s Best Practices for Researchers](/web/20260617040225/https://www.pnas.org/pb-assets/authors/TRRP_Best-Practices-for-Researchers-1667916710883.pdf)
...
*   [PNAS LaTeX template](/web/20260617040225/https://www.pnas.org/pb-assets/authors/PNAS-template-main-1764608845890.tex)
*   [Main class file](/web/20260617040225/https://www.pnas.org/pb-assets/authors/pnas-new-1764608846380.cls)
*   [Main style file](/web/20260617040225/https://www.pnas.org/pb-assets/authors/pnasresearcharticle-1764608846380.sty)
*   [Equations spanning two columns](/web/20260617040225/https://www.pnas.org/pb-assets/authors/widetext-1633460330490.sty)
*   [Bibliography style file](/web/20260617040225/https://www.pnas.org/pb-assets/authors/pnas-new-1764608845930.bst)
*   [Additional LaTeX Instructions](/web/20260617040225/https://www.pnas.org/pb-assets/authors/pnas_additional_latex_instructions-1633460324960.pdf)
...
*   Use [pnas-new.bst](/web/20260617040225/https://www.pnas.org/pb-assets/authors/pnas-new-1764608845930.bst) for the current PNAS bibliography style.
...
Supply figures and schemes as high-resolution files whenever possible. Please review the [PNAS Digital Art Guidelines](/web/20260617040225/https://www.pnas.org/pb-assets/authors/digitalart-1675347574760.pdf) before uploading images.
...
Images composed of pixels (also called “bitmapped” or “pixelmapped” images). Use for non–line art images, e.g., scanned artwork, digital photographs, complex imagery, and color effects such as blended colors, shading, shadows, and gradients.

Images composed of paths (points, lines, and curves) that are created with mathematical formulas. Use for line art images, e.g., graphs, polygons, logos, illustrations, circles, and ellipses, all predominantly composed of solid colors with sharp lines and contrasts.

Sample

![](/web/20260617040225im_/https://www.pnas.org/pb-assets/images/authors/raster-1633446220407.png)

*   Notice pixelation and blurriness of numbers,and jagged edges of lines. For details, magnify image by using zoom function.

![](/web/20260617040225im_/https://www.pnas.org/pb-assets/images/authors/vector-1633446220423.png)

*   Notice continuous smooth paths of numbers and lines. For details, magnify image by using zoom function.

Resolution

*   Graphics are resolution dependent; scaling to different sizes results in quality loss.
*   Images with large dimensions will maintain large file sizes.

*   Graphics are **not** resolution dependent; they can be scaled to any size without quality loss.
*   Images with large dimensions will maintain smaller file sizes.

File types

*   JPGs, GIFs, TIFFs, and EPSs/PDFs originating from raster programs.
*   Common programs: Adobe Photoshop, Corel Painter, SketchBook Pro, and GIMP.

*   AIs, and PPTs/EPSs/PDFs originating from vector programs.
*   Common programs: Adobe Illustrator, Corel DRAW, Sketch, PowerPoint, and Canva.

Requirements and tips

*   300 ppi for grayscale or color images with no type or lettering, 600–900 ppi for grayscale or color images with type, and 1000–1200 ppi for line art, e.g., bar graphs.
*   Color mode should be RGB.
*   Avoid embedding text in graphics.
*   Raster-based files can have low resolution in the published article, as they cannot be altered in size without losing quality.

*   300 dpi for grayscale or color images with no type or lettering, 600–900 dpi for grayscale or color images with type, and 1000–1200 dpi for line art, e.g., bar graphs.
*   Color mode should be RGB.
*   Best for creating text in graphics.
*   Vector-based files provide maximum flexibility for sizing your figures, as they can be altered in size while maintaining high-quality resolution.
...
*   When applicable, provide the _P_ value, magnification, or scale bar information. 
*   Indicate the number of independent data points (_N_) represented in a graph in the legend.
...
*   If there are more than five authors, list the first author’s name followed by _et al_.
...
10\. J.-M. Neuhaus, L. Sticher, F. Meins, Jr., T. Boller, A short C-terminal sequence is necessary and sufficient for the targeting of chitinases to the plant vacuole. _Proc. Natl. Acad. Sci. U.S.A_. **88**, 10362–10366 (1991).

C. Corsello _et al._, _FOXP1_\-related intellectual disability syndrome: A recognizable entity. _J. Med. Genet._, in press.

**Research datasets**

12\. E. van Sebille, M. Doblin, Data from “Drift in ocean currents impacts intergenerational microbial exposure to temperature.” Figshare. Available at [https://dx.doi.org/10.6084/m9.figshare.3178534.v2.](https://web.archive.org/web/20260617040225/https://dx.doi.org/10.6084/m9.figshare.3178534.v2) Deposited 15 April 2016.

**Articles or chapters in books**

14\. A. V. S. Hill, “HLA associations with malaria in Africa: Some implications for MHC evolution” in Molecular Evolution of the _Major Histocompatibility Complex_, J. Klein, D. Klein, Eds. (Springer, 1991), pp. 403–420.

**Preprints**

15\. H. Luetkens _et al._, Electronic phase diagram of the LaO1-xFxFeAs superconductor. arXiv \[Preprint\] (2008). [https://arxiv.org/abs/0806.3533](https://web.archive.org/web/20260617040225/https://arxiv.org/abs/0806.3533) (accessed 6 November 2020).

**Conference proceedings**

7\. C. Trepo, “Modelization of the epidemic” in _Proceedings of the Twelfth International Symposium on Viral Hepatitis and Liver Disease_, H. Alter, J. Maynard, W. Szmuness, Eds. (Franklin Institute Press, Philadelphia, PA, 2006), pp. 809–810.

**Archived code**

2\. C. Reynaud _et al_., Tomography. Zenodo. [https://doi.org/10.5281/zenodo.3712368](https://web.archive.org/web/20260617040225/https://doi.org/10.5281/zenodo.3712368). Deposited 15 July 2020.

**Theses or dissertations**

3\. D. P. Hua, "Unique allosteric mechanism regulating protein-protein interaction through phosphorylation: A case study of the conformational changes in the syk tandem sh2 protein," PhD thesis, Purdue University, West Lafayette, IN (2016); Available from [https://docs.lib.purdue.edu/open\_access\_dissertations/1367](https://web.archive.org/web/20260617040225/https://docs.lib.purdue.edu/open_access_dissertations/1367/)
...
*   _SI Appendix_: Supply a single PDF, combining all text, figures, tables, movie legends, and SI references. [See the PNAS SI template](/web/20260617040225/https://www.pnas.org/pb-assets/authors/PNAStemplateSI-1755285180080.docx).
*   _Datasets_: Supply XLSX, RTF, PDF, CSV, GZ, or TXT files.
*   _Movies_: Supply AVI, MOV, WMV, GIF, or MPEG files at the desired reproduction size and length. Movies are limited to 10 MB in size. Include a brief legend for each movie in the SI Appendix.
*   _Software_: Supply source code or scripts in native file types.
...
Authors are invited to submit scientifically interesting and visually arresting images to be considered for our cover (see our [archive](/web/20260617040225/https://www.pnas.org/content/by/year)). Illustrations need not appear in the article but should be representative of the work. Images should be original, and authors must grant PNAS a License to Publish. AI-generated images and stock photography will not be considered.

To submit an image for consideration for the PNAS cover:

*   Submit the image with your manuscript through the PNAS manuscript submissions system, or email the image to [\[email protected\]](about:/web/20260617040225/https://www.pnas.org/cdn-cgi/l/email-protection#6e3e202f3d2d01180b1c1d2e000f1d400b0a1b). Contact PNAS for instructions on submitting large files.
