...
Any relevant funding information for primary research papers should be declared in a separate funding statement. Funding should be declared only if the work in the article is within scope of the grant and arose directly from a specific grant.
...
See guidance and resources related to the use and reporting of statistics.
